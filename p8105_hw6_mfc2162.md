...
gestational age (categorical), mother’s age (categorical), mother’s
race, mother’s pre-pregnancy BMI, and average number of cigarettes
smoked per day (categorical).
...
```
    ...
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -1770.90  -212.24   -10.24   209.26  2297.70 
    ## 
    ## Coefficients:
    ##              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept) -4539.077     97.104  -46.74   <2e-16 ***
    ## blength       133.554      1.986   67.25   <2e-16 ***
    ## gaweeks        25.563      1.688   15.14   <2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 326.6 on 4335 degrees of freedom
    ## Multiple R-squared:  0.5937, Adjusted R-squared:  0.5935 
    ## F-statistic:  3167 on 2 and 4335 DF,  p-value: < 2.2e-16
...
```
    ...
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -1197.54  -188.82    -9.49   180.07  1689.60 
    ## 
    ## Coefficients:
    ##                             Estimate Std. Error t value Pr(>|t|)   
    ## (Intercept)               -2607.4156  1112.8312  -2.343  0.01917 * 
    ## bhead                        39.5317    34.4249   1.148  0.25089   
    ## blength                      13.1003    23.4904   0.558  0.57709   
    ## babysexmale               -2956.8451  1677.3112  -1.763  0.07800 . 
    ## bhead:blength                 2.2434     0.7168   3.130  0.00176 **
    ## bhead:babysexmale            80.4929    51.2432   1.571  0.11630   
    ## blength:babysexmale          62.4089    34.9851   1.784  0.07451 . 
    ## bhead:blength:babysexmale    -1.7304     1.0557  -1.639  0.10127   
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 283 on 4330 degrees of freedom
    ## Multiple R-squared:  0.6952, Adjusted R-squared:  0.6947 
    ## F-statistic:  1411 on 7 and 4330 DF,  p-value: < 2.2e-16
...
for (i in 1:5000) {
  boot_straps_tidy[i, "sample_id"] = i
