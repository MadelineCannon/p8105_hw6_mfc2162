...
The final model includes baby's sex, baby's head circumference, baby's length, mother's delivery weight (categorical), family income, gestational age, mother's age (categorical), mother's race, mother's pre-pregnancy BMI, and average number of cigarettes smoked per day (categorical).
